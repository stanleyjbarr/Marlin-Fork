...
#define STRING_CONFIG_H_AUTHOR "(Stan, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Dr. SJB's Ender3 PRO "  //  __DATE__ " 
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    //#define DEFAULT_Kp  21.73 SJB
    //#define DEFAULT_Ki   1.54 SJB 
    //#define DEFAULT_Kd  76.55 SJB 
...
/*
Recv: MPC_BLOCK_HEAT_CAPACITY 13.33
Recv: MPC_SENSOR_RESPONSIVENESS 0.3763
Recv: MPC_AMBIENT_XFER_COEFF 0.1173
Recv: MPC_AMBIENT_XFER_COEFF_FAN255 0.1247
...
*/
  ...
  #define MPC_AMBIENT_XFER_COEFF { 0.1173f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1247f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
//SJB #define XY_PROBE_FEEDRATE (150*60)
#define XY_PROBE_FEEDRATE (150*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
//SJB #define Z_PROBE_FEEDRATE_FAST (4*60)
#define Z_PROBE_FEEDRATE_FAST (10*60) // SJB 
...
// SJB #define Z_CLEARANCE_BETWEEN_PROBES  5 // Z Clearance between probe points
...
//SJB  #define GRID_MAX_POINTS_X 3
...
// SJB #define HOMING_FEEDRATE_MM_M { (20*60), (20*60), (4*60) }
